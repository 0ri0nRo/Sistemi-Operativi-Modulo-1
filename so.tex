...
Tra gli svantaggi possiamo affermare che risulta quasi impossibile prevedere la quantità di tempo CPU di un lavoro. Un'altro contro riguarda i lavori legati alla CPU a esecuzione prolungata possono morire di fame (come hanno fatto implicitamente quelli legati all'I/O priorità maggiore rispetto a loro)
