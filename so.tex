...
\begin{figure}[hbt]
    \begin{center}
        \includegraphics[width=0.5\textwidth,keepaspectratio]{{im/lock2}}
        \caption{The Critical Section Problem}    
    \end{center}
\end{figure}
...
\begin{figure}[hbt]
    \begin{center}
        \includegraphics[width=0.5\textwidth,keepaspectratio]{{im/bw}}
        \caption{The Critical Section Problem}    
    \end{center}
\end{figure}
