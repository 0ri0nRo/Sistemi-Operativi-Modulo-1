...
Il primo lettore che arriva bloccherà su \texttt{rw\_mutex} se c'è attualmente un utente che sta accedendo ai dati. Tutti i lettori successivi si bloccheranno solo sul \texttt{mutex} per il loro turno di incremento \texttt{numReader}.
