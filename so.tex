...
Durante l'esecuzione, il processo passa da uno stato all'altro in base a: \item azioni del programma (ad esempio, chiamate di sistema) come azioni del sistema operativo (ad es. pianificazione) o azioni esterne (ad es. interruzioni).\\ 
