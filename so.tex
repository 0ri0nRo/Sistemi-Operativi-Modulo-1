...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            $\bar{T}_{waiting} = \frac{1}{n}\sum\limits_{i=1}^{n} T_{i}^{waiting}$ = $\frac{0 + 5 + 7}{3} = \frac{12}{3} = 4$
        \end{itemize}
    \end{itemize}
    ...
    \begin{itemize}
        \item Il waiting time medio, quindi, sarà:\\
        $\bar{T}_{waiting} = \frac{1}{n}\sum\limits_{i=1}^{n} T_{i}^{waiting}$ = $\frac{0 + 5 + 2}{3} = \frac{7}{3} \simeq 2.3$
    \end{itemize}
\pagebreak
    ...
    \begin{itemize}
        ...
        \end{figure}
        \\
        $\bar{T}_{waiting} = \frac{1}{n}\sum\limits_{i=1}^{n} T_{i}^{waiting}$ = $\frac{1 + 2 + 7}{3} = \frac{10}{3} \simeq 3.3$
    \end{itemize}
\end{enumerate}
