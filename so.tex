...
\begin{itemize}
    ...
    \item \textbf{Scan (ottimizzato)}: Si muove verso l'estremo più piccolo ma senza arrivare allo 0.
    \item \textbf{C-Scan (non-ottimizzato)}: La testina si muove verso l'estremo iniziale 0 e poi da quello massimo 100 a scendere.
