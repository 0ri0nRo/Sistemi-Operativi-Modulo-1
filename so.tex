...
\begin{itemize}
    ...
    \pagebreak
    \item Si consideri una memoria M di capacità pari a 100 bytes con frame di dimensione pari a 10 bytes. Dato l'indirizzo del byte 37, quale sarà l'indirizzo di pagina (p) e l'offset (interno alla pagina).
    \textbf{Svolgimento:}\par
    $p$ = 37 / 10 = 3\par
    ...
    \textbf{Svolgimento:}\par
    Si parte da 11 e si scende verso il valore più piccolo (in questo caso 11) e poi si risale:
    \begin{center}
        D = 0 +  $|$ 0 - 11$|$  = 11\par
        D = 11 + $|$ 16 - 0$|$  = 27\par
        D = 27 + $|$ 24 - 16$|$ = 35\par
